...
INSERT INTO VACINAS.ENDERECO (logradouro, numero, complemento, bairro, cidade, estado, cep, pais) VALUES
('Rua das Flores', '123', 'Apto 101', 'Jardim Primavera', 'São Paulo', 'SP', 12345678, 'Brasil'),
('Avenida Paulista', '2000', 'Sala 305', 'Bela Vista', 'São Paulo', 'SP', 98765432, 'Brasil'),
('Rua XV de Novembro', '456', '', 'Centro', 'Curitiba', 'PR', 12312312, 'Brasil'),
('Rua da Harmonia', '789', 'Casa', 'Boqueirão', 'Curitiba', 'PR', 87654321, 'Brasil'),
('Avenida Brasil', '1001', 'Apto 202', 'Copacabana', 'Rio de Janeiro', 'RJ', 11223344, 'Brasil'),
('Rua das Laranjeiras', '102', '', 'Laranjeiras', 'Rio de Janeiro', 'RJ', 44332211, 'Brasil'),
('Rua Bento Gonçalves', '303', '', 'Centro', 'Porto Alegre', 'RS', 55667788, 'Brasil'),
('Avenida Independência', '404', 'Sala 401', 'Independência', 'Porto Alegre', 'RS', 88776655, 'Brasil'),
('Rua Sete de Setembro', '505', 'Apto 503', 'Centro', 'Florianópolis', 'SC', 99887766, 'Brasil'),
('Rua das Palmeiras', '606', '', 'Trindade', 'Florianópolis', 'SC', 66554433, 'Brasil'),
('Avenida Goiás', '707', 'Apto 707', 'Setor Central', 'Goiânia', 'GO', 22334455, 'Brasil'),
('Rua 15 de Novembro', '808', 'Sala 810', 'Setor Marista', 'Goiânia', 'GO', 55443322, 'Brasil'),
('Rua Amazonas', '909', '', 'Centro', 'Belo Horizonte', 'MG', 33445566, 'Brasil'),
('Avenida Afonso Pena', '100', 'Sala 1001', 'Funcionários', 'Belo Horizonte', 'MG', 66557788, 'Brasil'),
('Rua José de Alencar', '111', '', 'Centro', 'Fortaleza', 'CE', 77668899, 'Brasil'),
('Avenida Beira Mar', '222', 'Apto 2201', 'Meireles', 'Fortaleza', 'CE', 99889977, 'Brasil'),
('Rua das Acácias', '333', '', 'Alphaville', 'Barueri', 'SP', 55668899, 'Brasil'),
('Avenida Tamboré', '444', 'Sala 404', 'Tamboré', 'Barueri', 'SP', 99887755, 'Brasil'),
('Rua das Oliveiras', '555', '', 'Centro', 'Campinas', 'SP', 88776644, 'Brasil'),
('Avenida Orozimbo Maia', '666', 'Sala 606', 'Cambuí', 'Campinas', 'SP', 44332200, 'Brasil'),
('Rua Rio Grande do Sul', '777', '', 'Centro', 'Salvador', 'BA', 11224455, 'Brasil'),
('Avenida Oceânica', '888', 'Apto 808', 'Ondina', 'Salvador', 'BA', 99880077, 'Brasil'),
('Rua Pernambuco', '999', '', 'Centro', 'Recife', 'PE', 22335566, 'Brasil'),
('Avenida Boa Viagem', '101', 'Apto 101', 'Boa Viagem', 'Recife', 'PE', 55446677, 'Brasil'),
('Rua Maranhão', '202', '', 'Centro', 'Natal', 'RN', 33447788, 'Brasil'),
('Avenida Roberto Freire', '303', 'Sala 303', 'Ponta Negra', 'Natal', 'RN', 77665544, 'Brasil'),
('Rua Paraíba', '404', '', 'Centro', 'Manaus', 'AM', 44556677, 'Brasil'),
('Avenida Djalma Batista', '505', 'Sala 505', 'Chapada', 'Manaus', 'AM', 77889900, 'Brasil'),
('Rua Rio de Janeiro', '606', '', 'Centro', 'Belém', 'PA', 11226677, 'Brasil'),
('Avenida Almirante Barroso', '707', 'Apto 707', 'Marco', 'Belém', 'PA', 33449900, 'Brasil');
